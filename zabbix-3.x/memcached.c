...
**
** Version: 1.2 Last update: 2016-03-18 11:00
**
**/
...
int zbx_module_memcached_load_config(int requirement)
{
	...
	{
		zabbix_log(LOG_LEVEL_WARNING, "Parameter memcached_inst_ports must be defined, example: 11211, 192.168.9.9:11212, 11213");
		return ret;
	}
	else
	{
